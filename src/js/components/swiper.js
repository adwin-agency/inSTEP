...
export const teamSwiper = new Swiper(".team__list", {
  slidesPerView: 1.3,
  spaceBetween: 32,
  speed: 800,
  // loop: true,
...
export const historySwiper = new Swiper(".videos__slider", {
  slidesPerView: 1,
  spaceBetween: 10,
  speed: 800,
  loop: true,
...
export const aboutSwiper = new Swiper(".about__slider", {
  slidesPerView: 1,
  spaceBetween: 10,
  speed: 800,
  loop: true,
...
export const popupMainSwiper = new Swiper(".popup-card__main-slider", {
  slidesPerView: 1.5,
  spaceBetween: 10,
  speed: 800,
  // loop: true,
...
export const popupDuplicateSwiper = new Swiper(
